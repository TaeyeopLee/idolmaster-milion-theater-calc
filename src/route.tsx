...
const Router = ({ pageName }: { pageName: string }) => {
           ...
           <tbody>
             <tr style={{textAlign: 'center'}}>
               <td className="type_theater" id="theater_button">
                 <Link to='/theater' onClick={() => setCurrentPage('theater')}>시어터</Link>
               </td>
             </tr>
           </tbody>
         </table>
           ...
           <tbody>
             <tr style={{textAlign: 'center'}}>
               <td className="type_tour" id="tour_button">
                 <Link to='/tour' onClick={() => setCurrentPage('tour')}>투어</Link>
               </td>
             </tr>
           </tbody>
         </table>
           ...
           <tbody>
             <tr style={{textAlign: 'center'}}>
               <td className="type_tune" id="tune_button">
                 <Link to='/tune' onClick={() => setCurrentPage('tune')}>튠</Link>
               </td>
             </tr>
           </tbody>
         </table>
           ...
           <tbody>
             <tr style={{textAlign: 'center'}}>
               <td className="type_tale" id="tale_button">
                 <Link to='/tale' onClick={() => setCurrentPage('tale')}>테일</Link>
               </td>
             </tr>
           </tbody>
         </table>
...
// class RouterClass extends React.Component<any, any> {
